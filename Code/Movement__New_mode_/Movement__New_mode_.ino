...
void loop(){
  ...
  movement(S, 0, 100, 3, false);                                     // Calls a function that moves the platform with a combined speed, turning speed, and distances for each motor in cm, forward 34cm
  DistCorrection();
  
  movement(S/2, 180,0, 3, false);
  DistCorrection();
